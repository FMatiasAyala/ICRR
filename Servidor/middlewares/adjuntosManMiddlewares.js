...
const storage = multer.diskStorage({
  destination: (req, file, cb) => {
    const folderPath = "C:/CMMS_Folder/ICRR/Servidor/adjuntosMantenimientos"; // Ruta donde guardar los archivos
...
const adjuntosMantenimientos = multer({ storage: storage });

module.exports = { adjuntosMantenimientos };
