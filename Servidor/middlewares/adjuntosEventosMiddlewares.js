...
const storage = multer.diskStorage({
  destination: (req, file, cb) => {
    const folderPath = "C:/Users/mayala/Desktop/IDEAS/CMMS/ICRR/Servidor/adjuntosEventos"; // Ruta donde guardar los archivos
...
const adjuntosEventos = multer({ storage: storage });

module.exports = { adjuntosEventos };
